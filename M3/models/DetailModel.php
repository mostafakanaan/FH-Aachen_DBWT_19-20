...
namespace Emensa\Model {
    ...
    $query = 'SELECT Mahlzeiten.id, X.Gastpreis, X.`MA-Preis`, X.Studentpreis, Mahlzeiten.Name,Mahlzeiten.Beschreibung,Mahlzeiten.Vorrat,Mahlzeiten.Verfuegbar, P.`Alt-Text`,P.Titel,P.Binaerdaten
